                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-end">
                            <div class="dropdown">
                                ...
                                @endif
                                <a class="dropdown-item" href="{{route('ops.create')}}" class="menu-item"><i class="ik ik-edit"></i> New Checklist</a>
                                @if (Auth::user()->role_id==1)
                                    <a class="dropdown-item" href="{{route('checklists.index')}}" class="menu-item"><i class="ik ik-file-text"></i> Checklist Management</a>
                                @endif
                                <a class="dropdown-item" href="{{route('ops.index')}}" class="menu-item"><i class="ik ik-calendar"></i> Calendars</a>
                                <a class="dropdown-item" href="{{url('reports')}}"><i class="ik ik-file-text"></i><span>Health & Safety</span> </a>
