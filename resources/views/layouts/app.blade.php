                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                ...
                                <form method="POST" action="{{ route('login') }}" class="mr-2">
                                    @csrf
                                    <input hidden id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="subadminchch1@gmail.com" required autocomplete="email" autofocus>
                                    <input hidden id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="11111111" required autocomplete="current-password">
                                    <button type="submit" class="btn btn-secondary">
                                        Login as Sub-admin
                                    </button>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="mr-2">
                                    @csrf
                                    <input hidden id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="staffchch1@gmail.com" required autocomplete="email" autofocus>
                                    <input hidden id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="11111111" required autocomplete="current-password">
                                    <button type="submit" class="btn btn-secondary">
                                        Login as Staff
                                    </button>
